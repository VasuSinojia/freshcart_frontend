...
class _CartApiService implements CartApiService {
  ...
  Future<HttpResponse<BaseResponseModel>> addToCart({
    ...
    final _data = {'product_id': productId, 'quantity': quantity};
    final _options = _setStreamType<HttpResponse<BaseResponseModel>>(
  ...
  @override
  Future<HttpResponse<CartResponseModel>> getCart() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<CartResponseModel>>(
