...
class Swatch {
  MaterialColor myGreen = MaterialColor(0xFF53B175, {
    50: const Color(0xFF53B175).withValues(alpha: 0.005),
    100: const Color(0xFF53B175).withValues(alpha: 0.1),
    200: const Color(0xFF53B175).withValues(alpha: 0.2),
    300: const Color(0xFF53B175).withValues(alpha: 0.3),
    400: const Color(0xFF53B175).withValues(alpha: 0.4),
    500: const Color(0xFF53B175).withValues(alpha: 0.5),
    600: const Color(0xFF53B175).withValues(alpha: 0.6),
    700: const Color(0xFF53B175).withValues(alpha: 0.7),
    800: const Color(0xFF53B175).withValues(alpha: 0.8),
    900: const Color(0xFF53B175).withValues(alpha: 0.9)
  });
}
